...
reg delete "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FolderTypes\{885a186e-a440-4ada-812b-db871b942259}\TopViews\{00000000-0000-0000-0000-000000000000}" /v "GroupAscending" /f
reg delete "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FolderTypes\{885a186e-a440-4ada-812b-db871b942259}\TopViews\{00000000-0000-0000-0000-000000000000}" /v "GroupBy" /f
...
reg add "HKCU\Software\Microsoft\PowerShell\1\ShellIds\Microsoft.PowerShell" /v "EnableScripts" /t REG_DWORD /d "1" /f
...
reg add "HKLM\SOFTWARE\Classes\Local Settings\Software\Microsoft\Windows\CurrentVersion\AppContainer\Storage\microsoft.microsoftedge_8wekyb3d8bbwe\MicrosoftEdge\PhishingFilter" /v "PreventOverride" /t REG_DWORD /d "0" /f
...
reg add "HKLM\SOFTWARE\Microsoft\PowerShell\1\ShellIds\Microsoft.PowerShell" /v "EnableScripts" /t REG_DWORD /d "1" /f
...
reg add "HKLM\SOFTWARE\Microsoft\Windows Defender" /v "ServiceHardeningFlags" /t REG_DWORD /d "0" /f
...
reg add "HKLM\SOFTWARE\Microsoft\Windows Defender\Features" /v "SenseEnabled" /t REG_DWORD /d "0" /f
reg add "HKLM\SOFTWARE\Microsoft\Windows Defender\Features" /v "TamperProtection" /t REG_DWORD /d "0" /f
reg add "HKLM\SOFTWARE\Microsoft\Windows Defender\Features" /v "TamperProtectionSource" /t REG_DWORD /d "0" /f
reg add "HKLM\SOFTWARE\Microsoft\Windows Defender\NIS\Consumers\IPS" /v "AllowDatagramProcessingOnWinServer" /t REG_DWORD /d "0" /f
reg add "HKLM\SOFTWARE\Microsoft\Windows Defender\NIS\Consumers\IPS" /v "DisableBmNetworkSensor" /t REG_DWORD /d "1" /f
reg add "HKLM\SOFTWARE\Microsoft\Windows Defender\NIS\Consumers\IPS" /v "DisableDatagramProcessing" /t REG_DWORD /d "1" /f
reg add "HKLM\SOFTWARE\Microsoft\Windows Defender\Real-Time Protection" /v "AllowBehaviorMonitoring" /t REG_DWORD /d "0" /f
reg add "HKLM\SOFTWARE\Microsoft\Windows Defender\Real-Time Protection" /v "AllowIOAVProtection" /t REG_DWORD /d "0" /f
reg add "HKLM\SOFTWARE\Microsoft\Windows Defender\Real-Time Protection" /v "AllowRealtimeMonitoring" /t REG_DWORD /d "0" /f
reg add "HKLM\SOFTWARE\Microsoft\Windows Defender\Real-Time Protection" /v "DisableAsyncScanOnOpen" /t REG_DWORD /d "1" /f
reg add "HKLM\SOFTWARE\Microsoft\Windows Defender\Real-Time Protection" /v "DisableDriverUnload" /t REG_DWORD /d "0" /f
reg add "HKLM\SOFTWARE\Microsoft\Windows Defender\Real-Time Protection" /v "DisableDynamicRegHardening" /t REG_DWORD /d "1" /f
reg add "HKLM\SOFTWARE\Microsoft\Windows Defender\Real-Time Protection" /v "DisableEarlyLaunchAntimalware" /t REG_DWORD /d "1" /f
reg add "HKLM\SOFTWARE\Microsoft\Windows Defender\Real-Time Protection" /v "DisableRawWriteNotification" /t REG_DWORD /d "1" /f
...
reg add "HKLM\SOFTWARE\Microsoft\Windows Defender\Real-Time Protection" /v "DisableStackBasedCopyOptimization" /t REG_DWORD /d "1" /f
reg add "HKLM\SOFTWARE\Microsoft\Windows Defender\Real-Time Protection" /v "DpaDisabled" /t REG_DWORD /d "0" /f
reg add "HKLM\SOFTWARE\Microsoft\Windows Defender\Real-Time Protection" /v "MpEngine_DisableScriptScanning" /t REG_DWORD /d "1" /f
...
reg add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\AppHost\Main" /v "DEPOff" /t REG_DWORD /d "1" /f
reg add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\AppHost\Main" /v "Force Offscreen Composition" /t REG_DWORD /d "0" /f
...
reg add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FolderTypes\{885a186e-a440-4ada-812b-db871b942259}\TopViews\{00000000-0000-0000-0000-000000000000}" /v "PrimaryProperty" /t REG_SZ /d "System.ItemNameDisplay" /f
reg add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FolderTypes\{885a186e-a440-4ada-812b-db871b942259}\TopViews\{00000000-0000-0000-0000-000000000000}" /v "SortByList" /t REG_SZ /d "prop:System.ItemName" /f
...
reg add "HKLM\SOFTWARE\Policies\Microsoft\MicrosoftEdge\PhishingFilter" /v "PreventSmartScreenPromptOverride" /t REG_DWORD /d "0" /f
...
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows Defender" /v "ServiceHardeningFlags" /t REG_DWORD /d "0" /f
...
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows Defender\SmartScreen\ConfigureAppInstallControl" /v "AllowSmartScreen" /t REG_DWORD /d "0" /f
...
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\System" /v "RunAsPPLBoot" /t REG_DWORD /d "0" /f
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\System" /v "ShellSmartScreenLevel" /t REG_DWORD /d "0" /f
...
reg delete "HKLM\SYSTEM\CurrentControlSet\Services\MDCoreSvc" /v "FailureActions" /f
reg delete "HKLM\SYSTEM\CurrentControlSet\Services\msseccore" /v "FailureActions" /f
reg delete "HKLM\SYSTEM\CurrentControlSet\Services\SecurityHealthService" /v "FailureActions" /f
reg delete "HKLM\SYSTEM\CurrentControlSet\Services\Sense" /v "FailureActions" /f
...
reg delete "HKLM\SYSTEM\CurrentControlSet\Services\WdBoot" /v "FailureActions" /f
reg delete "HKLM\SYSTEM\CurrentControlSet\Services\WdDevFlt" /v "FailureActions" /f
reg delete "HKLM\SYSTEM\CurrentControlSet\Services\WdFilter" /v "FailureActions" /f
reg delete "HKLM\SYSTEM\CurrentControlSet\Services\WdNisDrv" /v "FailureActions" /f
reg delete "HKLM\SYSTEM\CurrentControlSet\Services\webthreatdefsvc" /v "FailureActions" /f
reg delete "HKLM\SYSTEM\CurrentControlSet\Services\webthreatdefusersvc" /v "FailureActions" /f
reg delete "HKLM\SYSTEM\CurrentControlSet\Services\WinDefend" /v "FailureActions" /f
reg delete "HKLM\SYSTEM\CurrentControlSet\Services\wscsvc" /v "FailureActions" /f
reg add "HKLM\SYSTEM\CurrentControlSet\Services\MDCoreSvc" /v "ErrorControl" /t REG_DWORD /d "0" /f
reg add "HKLM\SYSTEM\CurrentControlSet\Services\MDCoreSvc" /v "Start" /t REG_DWORD /d "4" /f
reg add "HKLM\SYSTEM\CurrentControlSet\Services\msseccore" /v "ErrorControl" /t REG_DWORD /d "0" /f
reg add "HKLM\SYSTEM\CurrentControlSet\Services\msseccore" /v "Start" /t REG_DWORD /d "4" /f
reg add "HKLM\SYSTEM\CurrentControlSet\Services\SecurityHealthService" /v "ErrorControl" /t REG_DWORD /d "0" /f
reg add "HKLM\SYSTEM\CurrentControlSet\Services\SecurityHealthService" /v "Start" /t REG_DWORD /d "4" /f
reg add "HKLM\SYSTEM\CurrentControlSet\Services\Sense" /v "ErrorControl" /t REG_DWORD /d "0" /f
...
reg add "HKLM\SYSTEM\CurrentControlSet\Services\WdBoot" /v "ErrorControl" /t REG_DWORD /d "0" /f
reg add "HKLM\SYSTEM\CurrentControlSet\Services\WdBoot" /v "Start" /t REG_DWORD /d "4" /f
reg add "HKLM\SYSTEM\CurrentControlSet\Services\WdDevFlt" /v "ErrorControl" /t REG_DWORD /d "0" /f
reg add "HKLM\SYSTEM\CurrentControlSet\Services\WdDevFlt" /v "Start" /t REG_DWORD /d "4" /f
reg add "HKLM\SYSTEM\CurrentControlSet\Services\WdFilter" /v "ErrorControl" /t REG_DWORD /d "0" /f
reg add "HKLM\SYSTEM\CurrentControlSet\Services\WdFilter" /v "Start" /t REG_DWORD /d "4" /f
reg add "HKLM\SYSTEM\CurrentControlSet\Services\WdNisDrv" /v "ErrorControl" /t REG_DWORD /d "0" /f
...
reg add "HKLM\SYSTEM\CurrentControlSet\Services\webthreatdefusersvc" /v "ErrorControl" /t REG_DWORD /d "0" /f
...
reg add "HKLM\SYSTEM\CurrentControlSet\Services\WinDefend" /v "ErrorControl" /t REG_DWORD /d "0" /f
reg add "HKLM\SYSTEM\CurrentControlSet\Services\WinDefend" /v "ObjectName" /t REG_SZ /d ".\Guest" /f
reg add "HKLM\SYSTEM\CurrentControlSet\Services\WinDefend" /v "Start" /t REG_DWORD /d "4" /f
reg add "HKLM\SYSTEM\CurrentControlSet\Services\WpnService" /v "Start" /t REG_DWORD /d "3" /f
reg add "HKLM\SYSTEM\CurrentControlSet\Services\wscsvc" /v "ErrorControl" /t REG_DWORD /d "0" /f
